module m_userfile
  ...
  !--- PRIVATE variables -----------------------------------------!
  real, private :: shift_gamma, E_drive
  !...............................................................!
...
contains
  ...
  subroutine userReadInput()
    ...
    call getInput('problem', 'E_drive', E_drive)
  ...
  subroutine userInitParticles()
    ...
    npart = INT(global_mesh % sx * global_mesh % sy * 0.25 * ppc0)
    do n = 1, npart
  ...
  subroutine userExternalFields(xp, yp, zp, &
    ...
    ex_ext = E_drive; ey_ext = 0.0; ez_ext = 0.0
