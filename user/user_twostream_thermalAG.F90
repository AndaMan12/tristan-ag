...
contains
  ...
  function userSpatialDistribution(x_glob, y_glob, z_glob, &
    ...
    userSpatialDistribution = (1 + dummy1 * sin(dummy2 * x_glob))/(1 + dummy1)
    return
  end function
  ...
  subroutine userInitParticles()
    ...
    call fillRegionWithThermalPlasma(fill_region, fill_species = (/1/), num_species = 1,&
     ndens_sp = np, temperature = TT, shift_gamma = shift_gamma, shift_dir = +1, dimension = 1,&
    ...
    call fillRegionWithThermalPlasma(fill_region, fill_species = (/2/), num_species = 1,&
     ndens_sp = ne, temperature = TT, shift_gamma = shift_gamma, shift_dir = -1, dimension = 1,&
     spat_distr_ptr = spat_distr_ptr, dummy1 = amplitude, dummy2 = mode)
